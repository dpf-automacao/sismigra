...
class SolicitacoesInternetPage < SitePrism::Page
  ...
  def preencher_dados_pessoais_internet(tipo_requerimento)
    ...
    if (@tipo_requerimento != "Alteracao_Endereco")
      ...
      @data_nascimento_alteracao_end = "01011999"
  ...
  def preencher_dados_endereco
    if (@tipo_requerimento != "Alteracao_Endereco")
      ...
      # VARIAVEIS PARA ENDERECO RESIDENCIAL
      ...
      # VARIAVEIS PARA ENDERECO COMERCIAL
      ...
      # VARIAVEIS PARA ENDERECO EXTERIOR
  ...
  def preencher_declaracao_captcha(minutos_total)
    ...
    if (has_impressao_da_solicitacao_form?(wait: 60))
      ...
      atualizar_conteudo("features/arquivos/requerimentos_utilizados/#{@tipo_requerimento}.txt", @nr_req)
      sleep(0.3)
    else
