...
=end
  ...
  element :avancar_com_perifetico_btn, :xpath, "//*[@id='j_id264']/div/div[3]/input[@value='Avançar']"
  element :avancar_sem_periferico_btn, :xpath, "//*[@id='j_id253']/div/div[3]/input[@value='Avançar']"
  ...
  def alterar_tipo_de_solicitacao(tipo_solicitacao)
    ...
    while (@indice < todos_tipos_de_solicitacao.size)
      sleep(0.5)
